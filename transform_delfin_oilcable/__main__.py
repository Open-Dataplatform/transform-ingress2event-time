...
from .transform import TransformDelfinOilcable
...
def __get_pipeline() -> TransformDelfinOilcable:
    ...
    try:
        return TransformDelfinOilcable(storage_account_url=account_url,
...
def main():
    ...
    logger.info('Running the delfin_oilcable transformation.')
    ...
    logger.info('Finished running the delfin_oilcable transformation.')
